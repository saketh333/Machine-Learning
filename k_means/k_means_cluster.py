...
for keys in data_dict:
    if data_dict[keys]["exercised_stock_options"]!= 'NaN':
        stock_values.add(data_dict[keys]["exercised_stock_options"])
print min(stock_values)
print max(stock_values)


salary_values = set()
for keys1 in data_dict:
    if data_dict[keys1]["salary"]!= 'NaN':
        salary_values.add(data_dict[keys1]["salary"])
...
financial_features_test = numpy.array([200000., 1000000.]).reshape(1,-1)
