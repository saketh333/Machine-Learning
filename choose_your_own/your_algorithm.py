...
#clf = AdaBoostClassifier(base_estimator = (clf1, clf2), n_estimators=100, learning_rate = 0.75)
...
clf1 = DecisionTreeClassifier(max_depth=None, min_samples_split=2,
    random_state=0)
scores1 = cross_val_score(clf1, features_train,labels_train)


clf2 = RandomForestClassifier(n_estimators=10, max_depth=None,
    min_samples_split=2, random_state=0)
scores2 = cross_val_score(clf2, features_train,labels_train)


#clf3 = ExtraTreesClassifier(n_estimators=10, max_depth=None,
#    min_samples_split=2, random_state=0)
#scores3 = cross_val_score(clf3, features_train,labels_train)
